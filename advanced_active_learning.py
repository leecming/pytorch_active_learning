...
class AdvancedActiveLearning():
    ...
    def get_uncertain_model_outlier_samples(self, model, outlier_model, unlabeled_data, validation_data, method,
                                            feature_method,
    ...
    def get_representative_cluster_samples(self, training_data, unlabeled_data, number=10, num_clusters=20,
                                           max_epochs=10, limit=10000):
    ...
    def get_deep_active_transfer_learning_uncertainty_samples(self, model, unlabeled_data, validation_data,
                                                              feature_method,
    ...
    def get_atlas_samples(self, model, unlabeled_data, validation_data, feature_method,
        ...
        while (len(atlas_samples) < number):
            samples = self.get_deep_active_transfer_learning_uncertainty_samples(model, unlabeled_data, validation_data,
                                                                                 feature_method, number_per_iteration,
                                                                                 limit, epochs, select_per_epoch)
            for item in samples:
